(deftheme marcus
  "Theme Marcus. Based on Tango dark.")
...
;      (js2external "#ce5c00")
  ...
  (custom-theme-set-faces
   ...
   ;; js2
   `(js2-function-param ((,class (:slant normal :foreground ,js2param))))
   `(js2-external-variable ((,class (:foreground ,js2external :background "black"))))
   ;`(js2-warning ((,class (:background ,js2warning))))
   ;`(js2-error ((,class (:background ,js2error))))

   `(diff-hl-insert ((,class (:background ,insert))))
   `(diff-hl-delete ((,class (:background ,delete))))
   `(diff-hl-change ((,class (:background ,change))))

   `(cursor ((,class (:background ,cursor))))
   ;; Highlighting faces
   `(fringe ((,class (:background ,fringe))))
   `(highlight ((,class (:foreground ,fg :background ,region))))
   `(region ((,class (:background ,region))))
   `(secondary-selection ((,class (:background ,blue-3))))
   `(isearch ((,class (:foreground ,alum-1 :background ,"orange"))))
   ...
   `(minibuffer-prompt ((,class (:foreground ,orange-3))))
...
(provide-theme 'marcus)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; marcus-theme.el ends here

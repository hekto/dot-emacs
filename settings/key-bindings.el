      ...
      (let ((msg (elt error 8)))
        (cond ((string= msg "space-in-parens")
               (cond ((looking-back "(") (insert " "))
                     ((looking-back ")") (left-char) (insert " "))))
              ((string= msg "array-bracket-spacing")
               (cond ((looking-at "\\[") (right-char) (insert " "))
                     ((looking-at "]") (insert " "))))
              ((string= msg "space-before-blocks")
               (cond ((looking-at "{") (insert " "))))
              ((string= msg "space-infix-ops")
               (if (looking-back "[^ ]") (insert " "))
               (forward-same-syntax 1) (if (looking-at "[^ ]") (insert " ")))
              ((string= msg "no-var")
               (cond ((looking-at "var") (kill-word 1) (insert "const"))))
              ((string= msg "computed-property-spacing")
               (cond ((looking-at "\\[") (right-char) (insert " "))
                     ((looking-at "]") (insert " "))
                     ((looking-at "{") (right-char) (insert " "))
                     ((looking-at "}") (insert " "))))
              ((string= msg "object-curly-spacing")
               (cond ((looking-at "\\[") (right-char) (insert " "))
                     ((looking-at "]") (insert " "))
                     ((looking-back "{") (insert " "))
                     ((looking-at "}") (insert " "))))
